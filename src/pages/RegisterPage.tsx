        ...
        <div className="lg:w-7/12 p-6 lg:p-10 bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="group w-full flex justify-center items-center gap-3 py-3 px-6 border border-transparent rounded-xl shadow-[0_15px_30px_-10px_rgba(37,99,235,0.3)] text-base font-bold text-white bg-brand hover:bg-brand-dark focus:outline-none focus:ring-4 focus:ring-brand/20 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-slate-100 transition-all text-sm font-bold text-slate-700 shadow-sm disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {isGoogleLoading ? (
                  <div className="w-5 h-5 border-2 border-slate-400/30 border-t-slate-900 rounded-full animate-spin"></div>
                ) : (
                  <>
